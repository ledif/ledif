...
Personal interests:
- Fedora Atomic desktops ([Aurora](https://github.com/ublue-os/aurora)/[Bazzite](https://github.com/ublue-os/bazzite)/[Universal Blue](https://github.com/ublue-os) and [Blue95](https://github.com/winblues/blue95)), Tarot ([Arcana Land](https://github.com/arcanaland)), golang
